\documentclass[11pt,french]{report}
  ...
  \usepackage{tabularx}
  \usepackage{multirow}
  \setlength{\parindent}{0pt} %retrait indentation début de texte
...
%%%%%%%%%%%%% Content %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{tex/intro_cred}

\input{tex/cred_stab}

\input{tex/cred_bayes}

\input{tex/buhlmann}

\input{tex/buhlmann_straubb}

\input{tex/reserve_IARD}
